...
let GoodsPropertyService = class GoodsPropertyService {
    ...
    createGoodsProperty(goodsTypeId, name, type, inputType, list) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsType = yield this.goodsTypeRepository.findOneById(goodsTypeId);
            if (!goodsType) {
    ...
    updateGoodsProperty(id, name, type, inputType, list) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsProperty = yield this.goodsPropertyRepository.findOneById(id, { relations: ["goodsType", "values"] });
            if (!goodsProperty) {
    ...
    deleteGoodsProperty(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsProperty = yield this.goodsPropertyRepository.findOneById(id, { relations: ["goodsType"] });
            if (!goodsProperty) {
                throw new common_1.HttpException("指定id=" + id + "商品属性不存在", 404);
            }
            try {
