...
exports.ShopComponentProvider = {
    ...
    inject: [typeorm_1.getRepositoryToken(goods_entity_1.Goods), typeorm_1.getRepositoryToken(first_classify_entity_1.FirstClassify), typeorm_1.getRepositoryToken(second_classify_entity_1.SecondClassify), typeorm_1.getRepositoryToken(third_classify_entity_1.ThirdClassify)]
};

//# sourceMappingURL=shop.component.provider.js.map
