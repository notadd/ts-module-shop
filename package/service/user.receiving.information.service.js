...
let UserReceivingInformationService = class UserReceivingInformationService {
    ...
    getUserReceivingInformation(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const information = yield this.userReceivingInformationRepository.findOne(id);
            if (!information) {
    ...
    updateUserReceivingInformation(id, consignee, email, region, address, postCode, homePhone, mobilePhone) {
        return __awaiter(this, void 0, void 0, function* () {
            const userReveivingInformation = yield this.userReceivingInformationRepository.findOne(id);
...
//# sourceMappingURL=user.receiving.information.service.js.map
