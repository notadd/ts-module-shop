...
let PaySettingService = class PaySettingService {
    ...
    getPaySetting() {
        return __awaiter(this, void 0, void 0, function* () {
            const paySetting = yield this.paySettingRepository.findOne(1);
            if (!paySetting) {
                throw new common_1.HttpException("支付配置不存在", 404);
            }
            return paySetting;
        });
    }
    savePaySetting(aliPay, weixinPay) {
        return __awaiter(this, void 0, void 0, function* () {
            const paySetting = this.paySettingRepository.create({ id: 1, aliPay, weixinPay });
            try {
...
//# sourceMappingURL=pay.setting.service.js.map
