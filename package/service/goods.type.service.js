...
let GoodsTypeService = class GoodsTypeService {
    ...
    getGoodsType(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsType = yield this.goodsTypeRepository.findOne(id, { relations: ["properties"] });
            if (!goodsType) {
    ...
    updateGoodsType(id, name) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsType = yield this.goodsTypeRepository.findOne(id);
            if (!goodsType) {
                throw new common_1.HttpException("指定id=" + id + "商品类型不存在", 404);
            }
    ...
    deleteGoodsType(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsType = yield this.goodsTypeRepository.findOne(id, { relations: ["properties", "goodses"] });
            if (!goodsType) {
                throw new common_1.HttpException("指定id=" + id + "商品类型不存在", 404);
            }
