...
let PropertyValueService = class PropertyValueService {
    ...
    createPropertyValue(goodsId, goodsPropertyId, value, price) {
        return __awaiter(this, void 0, void 0, function* () {
            const goodsProperty = yield this.goodsPropertyRepository.findOne(goodsPropertyId, { relations: ["goodsType"] });
            if (!goodsProperty) {
                throw new common_1.HttpException("指定id=" + goodsPropertyId + "商品属性不存在", 404);
            }
            const goods = yield this.goodsRepository.findOne(goodsId, { relations: ["type"] });
            if (!goods) {
                throw new common_1.HttpException("指定id=" + goodsId + "商品不存在", 404);
            }
    ...
    updatePropertyValue(id, value, price) {
        return __awaiter(this, void 0, void 0, function* () {
            const propertyValue = yield this.propertyValueRepository.findOne(id, { relations: ["property"] });
            if (!propertyValue) {
    ...
    deletePropertyValue(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const propertyValue = yield this.propertyValueRepository.findOne(id);
            if (!propertyValue) {
                throw new common_1.HttpException("指定id=" + id + "属性值不存在", 404);
            }
            try {
...
//# sourceMappingURL=property.value.service.js.map
