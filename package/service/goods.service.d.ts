...
export declare class GoodsService {
    ...
    getRecycleGoodses(pageNumber: number, pageSize: number): Promise<Array<Goods>>;
    getGoods(id: number): Promise<Goods>;
    createGoods(name: string, no: string, basePrice: number, discountPrice: number, description: string, classifyId: number, goodsTypeId: number, brandId: number): Promise<void>;
    updateGoods(id: number, name: string, no: string, basePrice: number, discountPrice: number, description: string, classifyId: number, goodsTypeId: number, brandId: number): Promise<void>;
    deleteGoods(id: number): Promise<void>;
    softDeleteGoods(id: number): Promise<void>;
    softDeleteGoodses(ids: Array<number>): Promise<void>;
    restoreGoods(id: number): Promise<void>;
    restoreGoodses(ids: Array<number>): Promise<void>;
}
