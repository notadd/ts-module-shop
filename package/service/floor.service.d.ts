...
export declare class FloorService {
    ...
    createFloor(name: string, display: string, goodsIds: Array<number>): Promise<void>;
    updateFloor(id: number, name: string, display: string, goodsIds: Array<number>): Promise<void>;
