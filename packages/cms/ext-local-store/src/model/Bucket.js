...
__decorate([
    typeorm_1.OneToOne(type => ImageConfig_1.ImageConfig, imageConfig => imageConfig.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        cascadeRemove: true,
        lazy: false
...
__decorate([
    typeorm_1.OneToOne(type => AudioConfig_1.AudioConfig, audioConfig => audioConfig.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        cascadeRemove: true,
        lazy: false
...
__decorate([
    typeorm_1.OneToOne(type => VideoConfig_1.VideoConfig, videoConfig => videoConfig.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        cascadeRemove: true,
        lazy: false
    }),
    __metadata("design:type", VideoConfig_1.VideoConfig)
], Bucket.prototype, "video_config", void 0);
__decorate([
    typeorm_1.OneToMany(type => File_1.File, file => file.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        lazy: true
    }),
...
__decorate([
    typeorm_1.OneToMany(type => Image_1.Image, image => image.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        lazy: true
    }),
...
__decorate([
    typeorm_1.OneToMany(type => Audio_1.Audio, audio => audio.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        lazy: true
    }),
...
__decorate([
    typeorm_1.OneToMany(type => Video_1.Video, video => video.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        lazy: true
    }),
...
__decorate([
    typeorm_1.OneToMany(type => Document_1.Document, document => document.bucket, {
        cascadeInsert: true,
        cascadeUpdate: true,
        lazy: true
    }),
